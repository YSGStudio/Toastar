  ...
  if (classCode) {
    return (
      <div className="rounded-2xl bg-white p-6 text-center shadow-sm">
        ...
        <p className="mt-2 text-3xl font-bold tracking-widest text-[#6C5CE7]">{classCode}</p>
        ...
        <button
          ...
          className="mt-6 w-full rounded-md bg-[#6C5CE7] py-2 text-sm font-medium text-white"
        >
          시작하기
        </button>
      </div>
